...
int main(int argc, char *argv[])
{
  ...
  readConfigFile(argv[1],"tree2doppler_map"); //grab data from the parameter file
  ...
  for (int i=0;i<stree->GetEntries();i++)
    {
      ...
      /* printf("pos %2d col %1d csi %2d df %.4f w %.4f\n",pos,col,csi,df_value,weight_value); */
      /* getc(stdin); */
    }
}
